...
This report is meant to be citizen data scientist friendly. The output is displayed in the rpubs report and the code is available in my github account. To get an idea of what we are working with, a table of the overall data sets is displayed below.
